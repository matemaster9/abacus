package org.mastercs.bigdata.scala_lang.oop.composition_inheritance

import org.mastercs.bigdata.scala_lang.oop.composition_inheritance.AbstractElem.elem
...
object AbstractElem {
    ...
    def elem(char: Char, height: Int, width: Int): AbstractElem = new UniformElem(char, height, width)
